...
class ThunderIDCreateOrganization extends StatelessWidget {
  final void Function(Organization org)? onCreated;
  final VoidCallback? onError;

  const ThunderIDCreateOrganization({super.key, this.onCreated, this.onError});

  @override
  Widget build(BuildContext context) {
    final state = ThunderIDProvider.of(context);
    return BaseThunderIDCreateOrganization(
      onCreated: onCreated,
      onError: onError,
...
class BaseThunderIDCreateOrganization extends StatefulWidget {
  final void Function(Organization org)? onCreated;
  final VoidCallback? onError;
  ...
  const BaseThunderIDCreateOrganization({
    super.key,
  ...
  @override
  State<BaseThunderIDCreateOrganization> createState() =>
      _BaseThunderIDCreateOrganizationState();
}

class _BaseThunderIDCreateOrganizationState
    extends State<BaseThunderIDCreateOrganization> {
