...
class ThunderOrganizationProfile extends StatelessWidget {
  const ThunderOrganizationProfile({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseThunderOrganizationProfile(
...
class BaseThunderOrganizationProfile extends StatefulWidget {
  ...
  const BaseThunderOrganizationProfile({super.key, required this.builder});

  @override
  State<BaseThunderOrganizationProfile> createState() => _BaseThunderOrganizationProfileState();
}

class _BaseThunderOrganizationProfileState extends State<BaseThunderOrganizationProfile> {
  Organization? _org;
